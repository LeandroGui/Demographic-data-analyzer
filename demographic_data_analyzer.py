...
def calculate_demographic_data(print_data=True):
    ...
    higher_education_rich = (higher_education[higher_education['salary']=='>50K']['salary'].count() / higher_education['salary'].count() * 100).round(1)
    lower_education_rich = (lower_education[lower_education['salary']=='>50K']['salary'].count() / lower_education['salary'].count() * 100).round(1) 
    ...
    rich_percentage = (df[df['hours-per-week']== df['hours-per-week'].min() & (df["salary"] == ">50K")]['salary'].count() / num_min_workers * 100).round(1)
